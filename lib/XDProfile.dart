    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
                ...
                Pinned.fromPins(
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      Align(
                        alignment: Alignment(-0.029, -0.029),
                        child: SizedBox(
                          width: 30.0,
                          height: 30.0,
                          child: SvgPicture.string(
          ...
          Pinned.fromPins(
            Pin(size: 69.0, start: 30.0),
            Pin(size: 27.0, middle: 0.3293),
            child: Text(
              'History',
              style: TextStyle(
                fontFamily: 'Avenir',
